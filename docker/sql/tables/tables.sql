...
create view recordstorageterm as select r.*, s.storagetermid, s.storagekey, s.value  from record r left join storageterm s on r."type" =s.recordtype and r.id =s.recordid ;
